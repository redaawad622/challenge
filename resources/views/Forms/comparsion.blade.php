...
<section class="pri">
    ...
    <form class="f-form-search" action="/searchCom" method="post">
        {{csrf_field()}}
                    ...
                    <td colspan="">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <a style="position: relative;" href="image/{{$report->url}}"><button class="btn btn-primary" style="background: #6495d7; ">Download</button></a>
